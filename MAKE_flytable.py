...
import mat73
os.chdir(r"C:\Users\Dhruvum Bajpai\Desktop\Computational Project\My Scripts\Python Conversion\Maps\2") #The 'r' before the directory converts it into a raw string
...
for i in range(0,len(flycell)):
    ...
    for j in range(0, len(flycell[i,2])):
                   fulltrial_temp.append(flycell[i,2][j])  
    trial_full.append(fulltrial_temp[0])
