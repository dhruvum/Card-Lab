...
ax(1) = subplot(2, 4, 1);
plot(head_vel_long_mean, 'r')
hold on
plot(head_vel_short_mean, 'b')
hold on
...
ax(2) = subplot(2, 4, 2);
plot(centre_vel_long_mean, 'r')
hold on
plot(centre_vel_short_mean, 'b')
hold on
plot(stimPlot, 'k', 'LineWidth', 2)
xline(stimLength, 'k', 'LineWidth', 2)
title('Centre')
...
ax(3) = subplot(2, 4, 3);
plot(t1left_vel_long_mean, 'r')
hold on
plot(t1left_vel_short_mean, 'b')
hold on
plot(stimPlot, 'k', 'LineWidth', 2)
xline(stimLength, 'k', 'LineWidth', 2)
title('T1 Left')
...
ax(4) = subplot(2, 4, 4);
plot(t1right_vel_long_mean, 'r')
hold on
plot(t1right_vel_short_mean, 'b')
hold on
plot(stimPlot, 'k', 'LineWidth', 2)
xline(stimLength, 'k', 'LineWidth', 2)
title('T1 Right')
...
ax(5) = subplot(2, 4, 5);
plot(t2left_vel_long_mean, 'r')
hold on
plot(t2left_vel_short_mean, 'b')
hold on
plot(stimPlot, 'k', 'LineWidth', 2)
xline(stimLength, 'k', 'LineWidth', 2)
title('T2 Left')
...
ax(6) = subplot(2, 4, 6);
plot(t2right_vel_long_mean, 'r')
hold on
plot(t2right_vel_short_mean, 'b')
hold on
plot(stimPlot, 'k', 'LineWidth', 2)
xline(stimLength, 'k', 'LineWidth', 2)
title('T2 Right')
...
ax(7) = subplot(2, 4, 7);
plot(t3left_vel_long_mean, 'r')
hold on
plot(t3left_vel_short_mean, 'b')
hold on
plot(stimPlot, 'k', 'LineWidth', 2)
xline(stimLength, 'k', 'LineWidth', 2)
title('T3 Left')
...
ax(8) = subplot(2, 4, 8);
plot(t3right_vel_long_mean, 'r')
hold on
plot(t3right_vel_short_mean, 'b')
hold on
plot(stimPlot, 'k', 'LineWidth', 2)
xline(stimLength, 'k', 'LineWidth', 2)
title('T3 Right')