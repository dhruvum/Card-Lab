...
%load([localPath 'ensembleCell.mat']);
load([localPath 'regionValue_by_trial_0.4.mat']);
%%
trial_regions = flycell(1, :);
idx_switch = flycell(2, :);
region_order = flycell(3, :);
region_count = flycell(4, :);
